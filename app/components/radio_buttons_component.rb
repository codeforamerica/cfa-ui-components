...
class RadioButtonsComponent < AttributeBoundFormElementComponent
  ...
  def initialize(form:, method:, collection:, item_value_method:, item_label_method:, legend:, scope: nil, layout: :vertical, small: false, bordered: false, warning_message: nil)
    super(form:, method:)
