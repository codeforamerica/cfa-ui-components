class LinkComponentPreview < ViewComponent::Preview
  ...
  def with_icon
    render(LinkComponent.new(label: "Continue to IRS.gov for more information about your federal tax return", url: "https://www.irs.gov", html_attrs: {class: UNVISITED_CLASSES}))
  end

  def same_tab
    render(LinkComponent.new(label: "Sign in", url: "/inspect/link/default", new_tab: false, html_attrs: {class: UNVISITED_CLASSES}))
  end
